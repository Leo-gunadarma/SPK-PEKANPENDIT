        ...
        [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'adminlte/plugins/datatables/jquery.dataTables.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'adminlte/plugins/datatables-bs4/js/dataTables.bootstrap4.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'adminlte/plugins/datatables-bs4/css/dataTables.bootstrap4.css',
                ],
            ],
        ],
        [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'adminlte/plugins/select2/css/select2.min.css',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'adminlte/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'adminlte/plugins/select2/js/select2.full.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'js/select2-bootstrap4-theme.js',
                ],
            ],
        ],
        [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'adminlte/plugins/toastr/toastr.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
